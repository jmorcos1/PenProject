...
// Define all the registers
 #define PROD_ID                          0x00 //--SBG
 #define REV_ID                           0x01 //--SBG
 #define MOTION_ST                        0x02 //--SBG
 #define DELTA_X                          0x03 //--SBG
 #define DELTA_Y                          0x04 //--SBG
 ...
 //#define SQUAL                            0x05
 #define SQUAL                            0x07 //--SBG
 
 //#define SHUT_HI                          0x06
 #define SHUT_HI                          0x0C //--SBG

 
 //#define SHUT_LO                          0x07
 #define SHUT_LO                          0x0B //--SBG
 
 //#define PIX_MAX                          0x08
 #define PIX_MAX                          0x08 //--SBG
 
 //#define PIX_ACCUM                        0x09
 #define PIX_ACCUM                        0x08 //--SBG ?
 
 #define PIX_MIN                          0x0a //--SBG
